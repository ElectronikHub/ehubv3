...
const team = [
  { name: "Sarah Johnson", position: "CEO", desc: "Visionary leader and strategist." },
  { name: "Michael Chen", position: "CTO", desc: "Tech innovator and architect." },
...
function TeamSection() {
  return (
    <section className="bg-gray-50 py-16 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full">
        {team.map((member) => (
